...
def get_vector_embeddings():
    if "vectors" not in st.session_state:
        ...
        st.session_state.loader=PyPDFDirectoryLoader("./data") ### Directory Loading
        st.session_state.docs = st.session_state.loader.load() ### Data/Document Loading
...
if st.button("Documents Embedding"):
    ...
    st.write("Your Vector Store DB is Ready")
